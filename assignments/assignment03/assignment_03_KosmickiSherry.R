...
setwd("/Users/kozfa/Documents/Github/dsc520")
...
ggplot(heights_df, aes(x=height, y=earn, col=sex)) + geom_jitter()
...
ggplot(heights_df, aes(x=height, y=earn, col=sex)) + geom_jitter() + ggtitle("Height vs. Earnings") + xlab("Height(inches)") + ylab("Earnings(dollars)")
